...
describe('#duplicate', () => {
  ...
  it('the params oi, ola, oi, foi are duplicated', () => {
    expect(duplicate('oi', 'ola', 'oi', 'foi')).toBeTruthy();
  });

  it('the params oi, ola, foi are not duplicated', () => {
    expect(duplicate('oi', 'ola', 'foi')).toBeFalsy();
  });
});
